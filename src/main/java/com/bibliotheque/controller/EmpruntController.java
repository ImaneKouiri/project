        ...
        if (empruntsTable != null) {
            ...
            colIsbn.setCellValueFactory(cellData -> 
                new javafx.beans.property.SimpleStringProperty(
                    cellData.getValue().getLivre() != null ? 
                    cellData.getValue().getLivre().getIsbn() : "N/A"
                )
            );
            colMembreId.setCellValueFactory(cellData -> 
                new javafx.beans.property.SimpleIntegerProperty(
                    cellData.getValue().getMembre() != null ? 
                    cellData.getValue().getMembre().getId() : 0
                ).asObject()
            );
